...
function loadCustomModels() {
  ...
  _.forEach(allModels , ( model ,modelName)=>{
    if( model.public && !_.includes( excludedModels , modelName) && !_.includes(models , modelName)  ){
...
module.exports = function(app, cb) {
  ...
  models.forEach( model=>{
    ...
    if( _.get( thisModel , "definition.settings.acls") && _.isEmpty(thisModel.definition.settings.acls)){
